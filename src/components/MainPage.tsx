...
// import LocationSearch from "./LocationSearch"; // Corrected import
import LocationSearch from "./Search"; // Corrected import

const MainPage = () => {
  const dispatch = useAppDispatch();

  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const handleSearch = async (searchResult: any) => {
  ...
  console.log("currentWeather", getCurrentWeather());
